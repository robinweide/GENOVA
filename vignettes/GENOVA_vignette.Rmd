...
```{r saddle, message=FALSE,  cache=T}
...
### Saddle-plot
```{r saddlePlot, message=FALSE,  fig.asp=.65, cache=T, warning=FALSE, fig.cap= "A saddle-plot"}
...
tmp = visualise.compartmentStrength(list(saddle_WT,
                                   saddle_WAPL))
```
