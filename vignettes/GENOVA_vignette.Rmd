...
```{r HMPdiff2, message=FALSE ,cache=T, fig.cap= "Hi-C matrixplot: diff. Note the ease of identifying the extended loops.",dev = 'png', dpi=300,cache=T,fig.asp=1, fig.small = T, fig.retina=T}
hic.matrixplot(exp1 = Hap1_WT_10kb,
               exp2 = Hap1_WAPL_10kb,
               coplot = 'diff',
               chrom = 'chr7',
