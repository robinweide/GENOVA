...
```r
Hap1_WT_10kb <- construct.experiment(signalPath = 'data/WT_10000_iced.matrix', 
...
Hap1_WAPL_10kb <- construct.experiment(signalPath = 'data/WAPL_10000_iced.matrix', 
                                  indicesPath = 'data/WAPL_10000_abs.bed', 
                                  name = "WAPL",
                                  centromeres = centromeres,
                                  color = "red")

Hap1_WT_100kb <- construct.experiment(signalPath = 'data/WT_100000_iced.matrix', 
...
Hap1_WAPL_100kb <- construct.experiment(signalPath = 'data/WAPL_100000_iced.matrix', 
...
```r
cisChrom_out <- cisTotal.perChrom(Hap1_WT_100kb)
```

\begin{smallfigure}
\includegraphics{/tmp/RtmposzzH5/preview-9fde6668163e.dir/GENOVA_vignette_files/figure-latex/cis-1} \caption{Fraction of cis-contacts per chromosome.}(\#fig:cis)
\end{smallfigure}
...
chromosomeMatrix(Hap1_WT_100kb, remove = c("M","Y"))
```

\begin{figure}
\includegraphics{/tmp/RtmposzzH5/preview-9fde6668163e.dir/GENOVA_vignette_files/figure-latex/chromMat-1} \caption{Chromosome matrix. The two known translocations of Hap1 cells are easily seen (15-19 \& 9-22).}(\#fig:chromMat)
\end{figure}
...
RCP_out <- RCP(experimentList = list(Hap1_WT_100kb, Hap1_WAPL_100kb), 
               chromsToUse = c('chr1','chr2','chr3','chr4','chr5'))
```
...
visualise.RCP.ggplot(RCPdata = RCP_out, 
                     ...
                     combine = F) # Do not merge data from all chromosomes
```

\begin{figure*}
\includegraphics{/tmp/RtmposzzH5/preview-9fde6668163e.dir/GENOVA_vignette_files/figure-latex/RCPPLOT1-1} \caption{RCP. Every facet shows the RCP of one chromosome.}(\#fig:RCPPLOT1)
\end{figure*}
...
\begin{smallfigure}
\includegraphics{/tmp/RtmposzzH5/preview-9fde6668163e.dir/GENOVA_vignette_files/figure-latex/RCPPLOT2-1} \caption{RCP. All data combined in one plot.}(\#fig:RCPPLOT2)
\end{smallfigure}
...
visualise.ATA.ggplot(stackedlist = list('WT' = ATA_Hap1_WT, 
                     ...
                     zlim1 = c(0,75),
                     zlim2 = c(-5,5), 
                     focus = 1) # which entriy in stackedlist to use as comparison
```

\begin{figure}
\includegraphics{/tmp/RtmposzzH5/preview-9fde6668163e.dir/GENOVA_vignette_files/figure-latex/ATAplot-1} \caption{ATA. In the WAPL-knockout, we see a decrease of contacts within the TAD, but an increase at the corner.}(\#fig:ATAplot)
\end{figure}
...
\begin{figure}
\includegraphics{/tmp/RtmposzzH5/preview-9fde6668163e.dir/GENOVA_vignette_files/figure-latex/iiDIFF-1} \caption{Differential TAD\\+N. Experiment 2 (WAPL) has more interactions between neighbouring TADs}(\#fig:iiDIFF)
\end{figure}
...
visualise.APA.ggplot(APAlist = list('WT' = APA_Hap1_WT, 
                     ...
                     zTop = c(0,12.5), # set the zlims of the upper row
                     zBottom = c(-8.33,8.33),
                     focus = 1) # which item in APAlist to use as comparison
```

\begin{figure}
\includegraphics{/tmp/RtmposzzH5/preview-9fde6668163e.dir/GENOVA_vignette_files/figure-latex/APAplot-1} \caption{ATA. In the WAPL-knockout, we see an increase of contacts at the loop.}(\#fig:APAplot)
\end{figure}
...
## [1] viridis_0.4.0     viridisLite_0.2.0 bindrcpp_0.2      GENOVA_0.9.5     
## [5] BiocStyle_2.6.1  
## 
...
## [34] reshape2_1.4.2         ggplot2_2.2.1          magrittr_1.5          
## [37] codetools_0.2-15       backports_1.1.2        scales_0.4.1          
## [40] htmltools_0.3.6        BiocGenerics_0.24.0    GenomicRanges_1.30.1  
## [43] assertthat_0.2.0       colorspace_1.3-2       labeling_0.3          
## [46] stringi_1.1.5          RCurl_1.95-4.9         lazyeval_0.2.0        
## [49] munsell_0.4.3
```
